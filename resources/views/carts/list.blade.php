            ...
            <div class="row cart_titel">
                                ...
                                <tr class="table_row">
                                    ...
                                    <td class="column-4 text-cent">
                                        <div class="wrap-num-product flex-w m-l-auto m-r-0 new-flex">
                                            ...
                                            <input class="input_w cl3 txt-center num-product bx-10" type="number" name="num_product[{{$product->id }}]" value="{{$carts[$product->id]}}">
                ...
                <div class="col-sm-10 col-lg-4 col-xl-5 m-lr-auto m-b-50 ">
                    <div class=" total-list bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm ">
                        ...
                        <button class="titel-car flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer">
                            Đặt Hàng
                        </button>
                    </div>
                </div>
