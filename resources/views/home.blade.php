...
@foreach($sliders as $slider)
    <div class="item-slick1" style="background-image:url({{ $slider->avatar }});">
                ...
                @foreach($categories as $category)
                    <div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
                        ...
                        <div class="block1 wrap-pic-w">
                            ...
                            <a href="/treshopHAT/public/danh-muc/{{ $category->id }}-{{ Str::slug($category->name,'-') }}.html" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
