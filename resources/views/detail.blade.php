                                          ...
                                          <span class="stock-brand-title">
                                              <strong>
                                                ...
                                                <span class="a-stock a2">
                                                        ...
                                                        <link itemprop="availability" /> Còn hàng</span>
                                                                                @else
                                                                                    <link itemprop="availability" /> Hết hàng</span>
                                                                                @endif
                                                                ...
                                                                <div class="col-md-3 col-sm-3 col-xs-6">
                                                                    <div class="ant-single-product simpleCart_shelfItem">
                                                                        <div class="ant-single-product-image">
                                                                            <a href="/treeshopHAT/public/san-pham/{{ $product->id }}-{{ Str::slug($product->name, '-') }}.html"><img
                                                                                    src="{{ $product->avatar }}"
                                                                                    alt="{{ $product->name }}'" 
                                                                                    class="img-responsive center-block item_thumb"
                                                                                /></a>
